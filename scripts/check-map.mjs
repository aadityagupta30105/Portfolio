// Map sanity checks: spawn, console access, decor bounds, reachability.
...
// Each console must be solid and approachable from every side.
...
// Some tile of each console ring must be reachable.
for (const z of INTERACTIONS) {
  let reachable = false;
