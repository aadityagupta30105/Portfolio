// Checks prop source rects in mapData.js against the real tileset pixels.
...
// Every edge tile of a rect must contain some of the sprite.
...
// Extents measured off the sheet.
const MEASURED = {
  rugRed: [7, 15, 4, 3],
  rugBlue: [13, 11, 3, 4],
  sofa: [7, 13, 3, 2],
